...
void S2_DrawTexture(float x, float y, S2_Texture* texture) {
...
void S2_DrawLimitedTexture(float x, float y, S2_Bound bound, S2_Texture * texture) {
...
void S2_DrawSprite(S2_Sprite *pSprite, float x, float y) {
